...
public class AppUtil {
    ...
    public static void installApp(Context context, File file){
        ...
        intent.setDataAndType(Uri.fromFile(file),"application/vnd.android.package-archvie");
     ...
     */
    public static boolean isIntallApp(Context context,String packageName){
